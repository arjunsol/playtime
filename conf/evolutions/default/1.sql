...
create table "model" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"application_id" BIGINT NOT NULL,"module_id" BIGINT NOT NULL);
